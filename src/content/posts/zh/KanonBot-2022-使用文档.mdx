...
cover: /images/posts/2022-kanonbot-usage-doc/cover.jpeg
top_img: /images/posts/2022-kanonbot-usage-doc/top_img.jpeg
...
<Note style="flat" type="warning" client:visible>
  使用过程中请遵守 [DESU.Life 最终用户使用许可协议（EULA）](https://desu.life/eula)
  指令系统已启用严格模式
  !command [arg1] [arg2] ✅
  !command[arg1][arg2] ❌
</Note>
